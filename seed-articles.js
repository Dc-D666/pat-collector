...
发布后点下面的「我已发表」按钮，系统会**自动检测**你的频道发帖记录——检测到新帖子就算完成。`,
    tasks: [
      {
        type: 'quiz',
      ...
      },
      {
        ...
        desc: '在 QQ 频道的 AI 轻应用功能里，用一句话创作一个应用并发布（需要 QQ 频道登录）。发布后点「我已发表」，系统自动检测你的发帖记录，检测通过即完成。',
        appcheck: true,
      },
    ],
  },
...
以前做这些要先学几个月编程，但现在有了 **AI 编程 Agent**——你负责描述需求，Agent 负责写代码、改 bug、加功能。

## 3. 认识三位"编程搭子"

| 工具 | 出品 | 特点 | 适合谁 |
| --- | --- | --- | --- |
| **Trae** | 字节跳动 | AI 原生 IDE（编程软件），装好后用中文对话就能让它写代码 | **入门首选**，国内下载快 |
| **WorkBuddy** | 腾讯云 | 桌面 AI Agent 工作台，自然语言指挥它完成代码/文档等任务 | 想要"全能助理"的同学 |
| **Codex** | OpenAI | 命令行 AI 程序员，在终端里跟它对话 | 硬核玩家、想更深入的同学 |

- **Trae**：[官网下载](https://www.trae.cn/ide/download)，trae.cn（支持 Windows / Mac / Linux）
...
上传后系统会自动检测你的上传记录，检测通过即完成——这也是你"AI 小学堂"的毕业作品！`,
    tasks: [
      {
        type: 'quiz',
  ...
  // ============ 第 4 章 AI 进阶 ============
  {
    ...
    chapter: 4,
    title: '把你的项目发布到全世界',
    summary: '项目做出来了，怎么让同学点个链接就能用？这一章教你免费把项目部署上线，成为真正"上架"的作品。',
    content: `第 3 章的项目还只存在你自己电脑里，同学想用也看不到。这一章把它**发布到网上**——给所有人一个能访问的链接。
